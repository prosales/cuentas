                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group{{ $errors->has('number_nog') ? ' has-danger' : '' }}">
                                    ...
                                    <input type="text" class="form-control{{ $errors->has('number_nog') ? ' is-invalid' : '' }}" name="number_nog" value="{{old('number_nog')}}" required>
                            ...
                            <div class="col-md-6">
                                <div class="form-group{{ $errors->has('municipality') ? ' has-danger' : '' }}">
                                    ...
                                    <input type="text" class="form-control{{ $errors->has('municipality') ? ' is-invalid' : '' }}" name="municipality" value="{{old('municipality')}}" required>
                            ...
                            <div class="col-md-6">
                                <div class="form-group{{ $errors->has('place') ? ' has-danger' : '' }}">
                                    ...
                                    <input type="text" class="form-control{{ $errors->has('place') ? ' is-invalid' : '' }}" name="place" value="{{old('place')}}" required>
                                    @if ($errors->has('place'))
