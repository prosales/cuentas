...
<main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-4 color">
    <div class="row mt-5">
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">Eliminar registro</div>

                <div class="card-body">
                    {{ Form::open(['method' => 'DELETE','route' => ['deposits.destroy', $registro->id]]) }}
                        <div class="row">
                            <div class="col-md-12">
                        ...
                        <div class="row mt-5">
                            <div class="col-md-12">
                                ...
                                <a href="{{ route('deposits.report') }}" class="btn btn-danger btn-lg">Cancelar</a>
                            </div>
                        </div>
                    {{ Form::close() }}
                </div>
